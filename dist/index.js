...
function generateClient(schemaFilePath, relativeSchemaFilePath) {
    ...
    return generateClientCode(pathsInterface, componentsInterface, relativeSchemaFilePath);
}
function findInterface(sourceFile, interfaceName) {
    return sourceFile.getInterfaces().find((i) => i.getName() === interfaceName);
}
function generateClientCode(pathsInterface, componentsInterface, relativeSchemaFilePath) {
