...
function generateClient(schemaFilePath) {
    ...
    return generateClientCode(pathsInterface, componentsInterface, node_path_1.default.basename(schemaFilePath));
}
function findInterface(sourceFile, interfaceName) {
    return sourceFile.getInterfaces().find((i) => i.getName() === interfaceName);
}
function generateClientCode(pathsInterface, componentsInterface, schemaFileName) {
